<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeFile="takeOutDataList.aspx.cs" Inherits="main_visit_listVisit" Title="Chi tiết đăng ký 신청 내역" %>
                ...
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    ...
                    <tr>
                        ...
                        <td class="contents_title">
                            Phòng bảo an (보안실) > Tài sản ra vào cổng (반출입)
                        </td>
                        <td align="right" class="location">
                            HOME &gt;Phòng bảo an (보안실) > Tài sản ra vào cổng (반출입)
                            <asp:Button ID="Button9" runat="server" Text="" BackColor="White" BorderColor="White"
                                ForeColor="White" Height="16px" Width="0px" />
                            <%-- 엔터버튼 클릭시 다음 버튼으로 이동하는 문제로 가짜버튼 만듬.(text 태그와 asp 컨트롤러 동시 사용으로 인해..)--%>
                        </td>
                    </tr>
                    <tr>
            ...
            <td valign="top">
				...
				<img src="../../images/icon/calendar.gif" alt="Chọn ngày (날짜선택)" style="cursor:hand" align="absmiddle"  onclick="popUpCalendar(this, document.forms[0].searchEndDate,'yyyy-mm-dd',-1,-1);" />--%>
                            <label>
                                From</label>
                            <input type="text" size="8" name="searchStartDate" value="<%=Request["startDate"]%>"
                                data-datepicker data-format="yyyy-MM-DD" />
                            <label>
                                To</label>
                            <input type="text" size="8" name="searchEndDate" value="<%=Request["endDate"]%>"
                                data-datepicker data-format="yyyy-MM-DD" />
                     ...
                     <asp:TextBox ID="searchEndDate" runat="server" data-datepicker data-format="yyyy-MM-DD" style="width : 85px" ></asp:TextBox>--%>
                        ...
                        <asp:ListItem Value="h.companyName">반출처</asp:ListItem>
                            ...
                            <select name="keyWord" align="absmiddle">
                                ...
                                <option value="h.companyName">Địa điêm (반출처)</option>
                                // nơi gửi đi
                            </select>
                ...
                <table width="100%">
                    <tr>
                        <td>
                            <asp:GridView ID="GridView1" runat="server" AllowPaging="True" CellPadding="3" PageSize="50"
                                OnRowDataBound="GridView1_RowDataBound1" Width="100%" AutoGenerateColumns="False"
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="ScheduleOutDate" HeaderText="Ngày dự định mang ra (반출 예정일)"
                                        Visible="False">
                                        <HeaderStyle HorizontalAlign="Center" />
                                        <ItemStyle HorizontalAlign="Center" />
                                    </asp:BoundField>
                                    <asp:BoundField DataField="ScheduleInDate" HeaderText="Ngày dự định mang vào (반입 예정일)"
                                        SortExpression="ScheduleInDate">
                                        <ItemStyle HorizontalAlign="Center" />
                                    </asp:BoundField>
                                    ...
                                    <asp:BoundField DataField="TakeOutDataCode" HeaderText="Xử lý tài sản ra/vào (반출입 처리)"
                                        SortExpression="TakeOutDataCode">
                                        <ItemStyle HorizontalAlign="Center" />
                                    </asp:BoundField>
                                </Columns>
                            ...
                            <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" SelectMethod="selectTakeOutDataList"
                                TypeName="HanaMicron.COMS.SQLServerDAL.TakeOutData">
                                <SelectParameters>
                                    ...
                                    <asp:QueryStringParameter Name="searchStartDate" QueryStringField="startDate" Type="String" />
                                    ...
                                    <asp:QueryStringParameter Name="requestUserCode" QueryStringField="employeeCode"
                                        Type="String" />
