<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeFile="visitDataList.aspx.cs" Inherits="main_visit_listVisit" Title="Chi tiết đăng ký (신청 내역)"
                ...
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    ...
                    <tr>
                        ...
                        <td class="contents_title">
                            Phòng bảo an (보안실) > Khách thăm (내방객)
                        </td>
                        <td align="right" class="location">
                            HOME &gt; Phòng bảo an (보안실) > Khách thăm (내방객)
                        </td>
                    </tr>
                    <tr>
        ...
        <tr>
            <td valign="top">
                <table width="100%">
                    <tr>
                        <td align="left">
                            <asp:Label ID="Label1" runat="server" Width="20px" BackColor="#FFF7A2" Text=""></asp:Label>&nbsp;
                            Khách thăm Free pass (Free pass 내방객)
                        </td>
                    ...
                    <tr>
                        <td style="text-align: center">
                            <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AutoGenerateColumns="False"
                                ...
                                EmptyDataText="Không có nội dung đăng ký (등록 된 내용이 없습니다).">
