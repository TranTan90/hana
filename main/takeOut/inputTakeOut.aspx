<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="inputTakeOut.aspx.cs" Inherits="main_takeOut_inputTakeOut" Title="Đăng ký tài sản ra cổng (반출 신청)" %>
...
<tr>
	...
	<table width="100%" border="0" cellspacing="0" cellpadding="0">
		...
		<tr>
			...
			<td class="contents_title">Đăng ký tài sản ra cổng (반출 신청)</td>
			<td align="right" class="location">HOME &gt;Đăng ký tài sản ra cổng (반출 신청)</td>
		</tr>
		<tr>
...
<tr>
	...
	<table width="100%" cellpadding="6" cellspacing="1" style="background-color:#CCCCCC" class="table table-bordered">
		<tr>
			<td colspan="6" class="title" style="background-color:#FFFFFF">Thông tin người đăng ký (신청자 정보)</td>
		</tr>
		<tr>
	...
	<table width="100%" cellpadding="6" cellspacing="1" border="0" style="background-color:#CCCCCC" class="table table-bordered">
		<tr>
			<td colspan="6" class="title" style="background-color:#FFFFFF">
				Đăng ký thông tin tài sản ra cổng (반출 정보 등록)</td>
		</tr>
		<tr>
			<td style="background-color:#F5F5F5;height:20px;">
				Mã tài sản ra cổng<br />(반출번호)
			</td>
			<td style="background-color:#FFFFFF;">
				<asp:Label ID="lblTakeOutDataCode" runat="server"></asp:Label>
			</td>
			<td style="background-color:#F5F5F5">
			    Ngày dự định mang ra cổng<br />(반출 예정일)
			</td>
			<td style="background-color:#FFFFFF">
			    <input type="text" name="scheduleOutDate" class="input form-control col-6"   readonly value="<%=scheduleDateOut%>"  data-datepicker data-format="yyyy-MM-DD"/>
			...
			<td style="background-color:#F5F5F5">
				...
				Ngày dự định mang vào<br />(반입 예정일)
				</div>
			</td>
			<td style="background-color:#FFFFFF">
				<div id="scheduleDateValue" style="display:none">
             
				<input type="text" name="scheduleInDate" class="input form-control col-6"  readonly  value="<%=scheduleDateTitle%>" data-datepicker data-format="yyyy-MM-DD" />
		...
		<tr>
			<td style="background-color:#F5F5F5">
				Mục đích mang ra<br />(반출목적)
			</td>
			<td style="background-color:#FFFFFF">
				<asp:DropDownList ID="takeOutObjectCode" runat="server" DataSourceID="ObjectDataSourceVisitObject" DataTextField="CodeName" DataValueField="TakeOutObjectCode" Width="223px" CssClass="form-control">
			...
			<td style="background-color:#F5F5F5">
				Mục đích chi tiết<br />(세부목적)
			</td>
			<td colspan="4" style="background-color:#FFFFFF">
				<input type="text" name="objectContents" class="input form-control" size="65" value="<%=objectContents%>" /></td>
		</tr>
		<tr>
			<td style="background-color:#F5F5F5">
				 Lộ trình tài sản ra cổng<br />(반출경로)
			</td>
			<td style="background-color:#FFFFFF" class="form-inline">
				<asp:DropDownList ID="takeOutPathStart" runat="server" DataSourceID="ObjectDataSource2" DataTextField="TakeOutPathStartName" DataValueField="TakeOutPathStartCode" CssClass="form-control col-3">
				...
				☞
				<asp:DropDownList ID="takeOutPathEnd" runat="server" DataSourceID="ObjectDataSource3" DataTextField="TakeOutPathEndName" DataValueField="TakeOutPathEndCode" CssClass="form-control col-4">
			...
			<td style="background-color:#FFFFFF">
				...
				<img src="../../images/icon/searchKor.gif" onclick="newWinByNameByScroll('../company/searchCompany.aspx','car',950,500)" style="cursor:hand;vertical-align:middle" alt="업체 조회" />
			</td>
			<td style="background-color:#F5F5F5">
				Người nhận<br />(수령자)
			</td>
			<td style="background-color:#FFFFFF">
				<input type="text" name="recieveName" class="input form-control" value="<%=recieveName%>" /></td>
		</tr>
		<tr>
			<td style="background-color:#F5F5F5">
				Có mang vào hay không<br />(반입여부)
			</td>
			<td style="background-color:#FFFFFF">
				<input type="radio" name="requireIN" value="1" onclick="displaySuffle()" <%=ckRequire1%> /> Cần mang vào (반입필)
				<input type="radio" name="requireIN" value="2" onclick="displaySuffle()" <%=ckRequire2%> /> Không thể mang vào (반입불가)
			</td>
			<td style="background-color:#F5F5F5">
		...
		<tr>
			...
			<td style="background-color:#FFFFFF" >
				...
				<input type="text" name="carNumber" value="<%=carNumber%>"  class="input form-control col-3" readonly />
				<img src="../../images/icon/searchKor.gif" onclick="newWinByNameByScroll('../car/searchCar.aspx','car',1000,500)" style="cursor:hand; alt="Tra cứu xe (차량 조회)" />                
                ...
                <img src="../../images/icon/write.gif" onclick="newWinByNameByScroll('../car/carEdit.aspx','car',600,500)" style="cursor:hand; alt="Đăng ký xe (차량 등록)" />
                <br />
		...
		<tr>
			<td colspan="8" style="background-color:#FFFFFF">
				...
				<tr align="center">
					<td>STT<br />(순번)</td>
					<td>Chọn (선택)</td>
					<td>Tài sản lớn<br />(대분류)</td>
					<td>Tài sản nhỏ<br />(소분류)</td>
					<td>Tên vật phẩm<br />(품명)</td>
					<td>Quy cách<br />(규격/Serial No)</td>
					<td>Số lượng<br />(수량)</td>
					<td>Đơn vị<br />(단위)</td>
				</tr>
				</table>
			</td>
