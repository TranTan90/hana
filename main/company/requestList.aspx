            ...
            <td align="left" valign="top" style="height: 24px">
                <table style="width: 100%" id="TABLE2">
                    <tr>
                        ...
                        <td align="right" style="height: 27px;">
                            ...
                            <asp:Button ID="btnSearch" runat="server" ValidationGroup="AllValidators" Text="Tìm kiếm (검색하기)"/>
                            <input type="button" value="Đăng ký (등록 신청하기)" onClick="window.location='inputCompany.aspx?mode=write'"/>
                        </td>
                    </tr>
                </table>
				<asp:GridView ID="GridView1" runat="server" AllowPaging="True" AutoGenerateColumns="False"
					...
					<Columns>
                        ...
                        <asp:HyperLinkField HeaderText="Xóa">
							<ItemStyle HorizontalAlign="Center" />
							<HeaderStyle HorizontalAlign="Center" Width="100px" />
						</asp:HyperLinkField>
					</Columns>
