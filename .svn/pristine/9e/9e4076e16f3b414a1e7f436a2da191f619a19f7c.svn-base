<%@ Page Language="C#" MasterPageFile="~/admin/admin.master" AutoEventWireup="true" CodeFile="takeOutPathStartEdit.aspx.cs" Inherits="_Default" Title="Quản lý tên tòa nhà (건물명 관리)" %>
