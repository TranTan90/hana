<%@ Page Language="C#" MasterPageFile="~/admin/admin.master" AutoEventWireup="true" CodeFile="securityList.aspx.cs" Inherits="admin_approve_approveList" Title="Quản lý nhân viên bảo an (보안요원 관리)" %>
