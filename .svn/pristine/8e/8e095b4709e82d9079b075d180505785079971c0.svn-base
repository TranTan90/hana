<%@ Page Language="C#" MasterPageFile="~/admin/admin.master" AutoEventWireup="true" CodeFile="takeOutPathEndList.aspx.cs" Inherits="_Default" Title="Người quản lý khách thăm ra/vào (내방 반출입 관리자)" %>
        ...
        <tr>
            <td align="left" valign="top" style="height: 24px;text-align:center">
                <table style="width: 100%" id="TABLE2">
                    <tr>
                        <td align="right" style="height: 27px;">
							...
							&nbsp;   <a href="takeOutPathEndEdit.aspx?mode=write"><img src="../../images/icon/write.gif" style="border-top-style: none; border-right-style: none;
				...
				<asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" CellPadding="4"
					...
					<Columns>
						<asp:BoundField DataField="TakeOutPathEndCode" HeaderText="Code (코드)" SortExpression="TakeOutPathEndCode">
							<ItemStyle HorizontalAlign="Center" />
							<HeaderStyle HorizontalAlign="Center" />
						</asp:BoundField>
						<asp:BoundField DataField="TakeOutPathEndName" HeaderText="Tên (이름)" SortExpression="TakeOutPathEndName">
							<ItemStyle HorizontalAlign="Center" />
							<HeaderStyle HorizontalAlign="Center" />
						</asp:BoundField>
				...
				<asp:ObjectDataSource ID="ObjectDataSource1" runat="server" SelectMethod="selectTakeOutPathEndList"
