<%@ Page Language="C#" MasterPageFile="~/admin/admin.master" AutoEventWireup="true" CodeFile="disApprovalCategoryList.aspx.cs" Inherits="_Default" Title="Người quản lý khách thăm ra/vào (내방 반출입 관리자)" %>
                ...
                <table style="width: 100%" id="TABLE2">
                    <tr>
                        <td align="right" style="height: 27px;">
							...
							&nbsp;<a href="disApprovalCategoryEdit.aspx?mode=write"><img src="../../images/icon/write.gif" style="border-top-style: none; border-right-style: none;
