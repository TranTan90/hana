<%@ Page Language="C#" MasterPageFile="~/admin/admin.master" AutoEventWireup="true" CodeFile="freepassList3.aspx.cs" Inherits="admin_manager_freepassList" Title="Quản lý Free pass (Free pass 관리)" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
	...
	<table>
		...
		<tr>
			...
			<td valign="middle">
				Người đăng ký Free pass (Freepass 등록자)<br />
