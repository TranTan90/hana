<%@ Page Language="C#" MasterPageFile="~/admin/admin.master" AutoEventWireup="true" CodeFile="disApprovalCategoryEdit.aspx.cs" Inherits="_Default" Title="Quản lý tòa nhà (건물명 관리)" %>
        ...
        <tr>
            ...
            <td style="background-color: #f5f5f5; height: 26px;">
                <asp:TextBox ID="txtStatus" runat="server" ValidationGroup="AllValidators"></asp:TextBox><asp:RequiredFieldValidator
                    ID="RequiredFieldValidator2" runat="server" ControlToValidate="txtStatus" ErrorMessage="Nhập thông tin sử dụng (사용유무를 입력해주세요)" ValidationGroup="AllValidators" Display="Dynamic">*</asp:RequiredFieldValidator>
