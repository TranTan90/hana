...
namespace HanaMicron.COMS.SQLServerDAL
{
	...
	public class TakeOutObject : ITakeOutObject
	{
		...
		public int updateTakeOutObject(TakeOutObjectInfo takeOutObjectInfo)
		{
            ...
            sql_update.Append("UPDATE TakeOutObject SET codeName=N'" + takeOutObjectInfo.CodeName + "' , status=N'" + takeOutObjectInfo.Status + "' WHERE takeOutObjectCode=" + takeOutObjectInfo.TakeOutObjectCode);
		...
		public int insertTakeOutObject(TakeOutObjectInfo takeOutObjectInfo)
		{
            ...
            sql_insert.Append(" (N'" + takeOutObjectInfo.CodeName + "', GETDATE(),N'" + takeOutObjectInfo.Status + "')");
