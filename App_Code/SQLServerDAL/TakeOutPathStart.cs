...
namespace HanaMicron.COMS.SQLServerDAL
{
	...
	public class TakeOutPathStart : ITakeOutPathStart
	{
		...
		public int  updateTakeOutPathStart(TakeOutPathStartInfo takeOutPathStartInfo)
		{
            ...
            sql_update.Append("UPDATE TakeOutPathStart SET takeOutPathStartName=N'" + takeOutPathStartInfo.TakeOutPathStartName + "', status=N'" + takeOutPathStartInfo.Status + "' WHERE takeOutPathStartCode=" + takeOutPathStartInfo.TakeOutPathStartCode);
		...
		public int  insertTakeOutPathStart(TakeOutPathStartInfo takeOutPathStartInfo)
		{
            ...
            sql_insert.Append(" (takeOutPathStartName,regDate,status) ");
			sql_insert.Append(" VALUES ");
			sql_insert.Append(" (N'" + takeOutPathStartInfo.TakeOutPathStartName + "',GETDATE(),N'" +takeOutPathStartInfo.Status+ "') ");
