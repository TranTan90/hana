<%@ Page Language="C#" MasterPageFile="~/admin/admin.master" AutoEventWireup="true" CodeFile="carCategoryEdit.aspx.cs" Inherits="_Default" Title="Người quản lý xe (차량 관리자)" %>
    ...
    <table style="width: 670px; clip: rect(auto auto auto auto);">
        ...
        <tr>
            <td style="width: 145px; background-color: #dcdcdc; height: 30px;" >
                Loại xe (차종)</td>  <%--Chủng loại xe: xe tải, xe bus, ...--%>
            <td style="background-color: #f5f5f5; height: 26px;">
                <asp:TextBox ID="codeName" runat="server" ValidationGroup="AllValidators"></asp:TextBox><asp:RequiredFieldValidator
                    ID="RequiredFieldValidator1" runat="server" ControlToValidate="codeName" ErrorMessage="Hãy nhập loại xe (차종을 입력하여 주십시요)" ValidationGroup="AllValidators" Display="Dynamic">*</asp:RequiredFieldValidator></td>
        </tr>
        <tr>
            <td style="width: 145px; background-color: #dcdcdc; height: 30px;" >
            ...
            <td style="background-color: #f5f5f5; height: 26px;">
                <asp:TextBox ID="txtStatus" runat="server" ValidationGroup="AllValidators"></asp:TextBox><asp:RequiredFieldValidator
                    ID="RequiredFieldValidator2" runat="server" ControlToValidate="txtStatus" ErrorMessage=" Hãy nhập tình trạng sử dụng (Yes = có sử dụng / No = không sử dụng) (사용유무를 입력해주세요)" ValidationGroup="AllValidators" Display="Dynamic">*</asp:RequiredFieldValidator>
                <span style="color: #ff0066">(chỉ nhập Y(có) hoặc N(không) (Y, N으로만 입력))</span></td>
        </tr>
        <tr>
