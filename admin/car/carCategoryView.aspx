...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
	<asp:DetailsView ID="DetailsView1" runat="server" AutoGenerateRows="False" BackColor="White"
		...
		<Fields>
			<asp:BoundField DataField="CarCategoryCode" HeaderText="code (코드)" SortExpression="CarCategoryCode" />
			<asp:BoundField DataField="CodeName" HeaderText="Tên loại xe (차종명)" SortExpression="CodeName" />
