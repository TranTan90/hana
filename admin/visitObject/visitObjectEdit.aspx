<%@ Page Language="C#" MasterPageFile="~/admin/admin.master" AutoEventWireup="true" CodeFile="visitObjectEdit.aspx.cs" Inherits="_Default" Title="Người quản lý xe (차량 관리자)" %>
        ...
        <tr>
            ...
            <td style="background-color: #f5f5f5; height: 26px;">
                <asp:TextBox ID="txtVisitObjectName" runat="server" ValidationGroup="AllValidators"></asp:TextBox><asp:RequiredFieldValidator
                    ID="RequiredFieldValidator1" runat="server" ControlToValidate="txtVisitObjectName" ErrorMessage="Hãy nhập mục đích (목적을 입력하여 주십시요)" ValidationGroup="AllValidators" Display="Dynamic">*</asp:RequiredFieldValidator></td>
        </tr>
        <tr>
            <td style="width: 145px; background-color: #dcdcdc; height: 30px;" >
            ...
            <td style="background-color: #f5f5f5; height: 26px;">
                <asp:TextBox ID="txtStatus" runat="server" ValidationGroup="AllValidators"></asp:TextBox><asp:RequiredFieldValidator
                    ID="RequiredFieldValidator2" runat="server" ControlToValidate="txtStatus" ErrorMessage="Hãy nhập thông tin xử dụng (사용유무를 입력해주세요)" ValidationGroup="AllValidators" Display="Dynamic">*</asp:RequiredFieldValidator>
