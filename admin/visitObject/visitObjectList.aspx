<%@ Page Language="C#" MasterPageFile="~/admin/admin.master" AutoEventWireup="true" CodeFile="visitObjectList.aspx.cs" Inherits="_Default" Title="Người quản lý khách thăm ra/vào (내방 반출입 관리자)" %>
        ...
        <tr>
            <td align="left" valign="top" style="height: 24px;text-align:center">
				...
				<asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" CellPadding="4"
					...
					Width="100%" BackColor="White" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px" GridLines="Horizontal">
					<FooterStyle BackColor="#CCCC99" ForeColor="Black" />
					<Columns>
						<asp:BoundField DataField="VisitObjectName" HeaderText="Mục đích thăm (방문 목적)" SortExpression="VisitObjectName">
				...
				<asp:ObjectDataSource ID="ObjectDataSource1" runat="server" SelectMethod="selectVisitObjectList"
					TypeName="HanaMicron.COMS.BLL.VisitObject">
				...
				<table style="width: 100%">
                    <tr>
                        <td>
							&nbsp;</td>
                        <td align="right">
                            <a href="visitObjectEdit.aspx?mode=write"><img src="../../images/icon/write.gif" style="border-top-style: none; border-right-style: none;
