<%@ Page Language="C#" MasterPageFile="~/admin/admin.master" AutoEventWireup="true" CodeFile="officeEdit.aspx.cs" Inherits="_Default" Title="Quản lý tòa nhà (건물명 관리)" %>
    ...
    <table style="width: 670px; clip: rect(auto auto auto auto);">
        ...
        <tr>
            ...
            <td style="background-color: #f5f5f5; height: 26px;">
                <asp:TextBox ID="txtOfficeName" runat="server" ValidationGroup="AllValidators"></asp:TextBox><asp:RequiredFieldValidator
                    ID="RequiredFieldValidator1" runat="server" ControlToValidate="txtOfficeName" ErrorMessage="Hãy nhập tên tòa nhà (건물명을 입력하여 주십시요)" ValidationGroup="AllValidators" Display="Dynamic">*</asp:RequiredFieldValidator></td>
        </tr>
        <tr>
            <td style="width: 145px; background-color: #dcdcdc; height: 30px;" >
            ...
            <td style="background-color: #f5f5f5; height: 26px;">
                ...
                <span style="color: #ff0066">(Chỉ nhập Y/N (Y, N으로만 입력))</span></td>
        </tr>
        <tr>
        ...
        <tr>
            <td style="height: 26px; background-color: #ffffff;" align="center" colspan="2">
                ...
                <span style="position:absolute"><a href="#" onclick="history.go(-1);"><img src="../../images/icon/cancel.gif" alt="Quay lại (돌아가기)" style="border-top-style: none; border-right-style: none; border-left-style: none; border-bottom-style: none;" /></a></span>
               </td>
        </tr>
    </table>
